...
class QuicConfiguration:
    ...
    # ADDED here
    # use to store invalid certificate
    invalid_certificate: Any = None
    invalid_certificate_chain: List[Any] = field(default_factory=list)
    ...
    # ADDED here
    # load invalid certificate and certificate chain
    def load_invalid_cert_chain(
        self,
        certfile: PathLike
    ) -> None:
        """
        Load a invalid certificate.
        """
        ...
        with open(certfile, "rb") as fp:
            ...
            if len(chunks) == 2:
                private_key = boundary + chunks[1]
                self.private_key = load_pem_private_key(private_key)
        self.invalid_certificate = certificates[0]
        self.invalid_certificate_chain = certificates[1:]